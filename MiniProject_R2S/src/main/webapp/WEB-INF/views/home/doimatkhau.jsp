							...
							<div class="control-group">
								...
								<div class="controls">
									<input type="password" placeholder="Nhập mật khẩu cũ"
										name="passwordcu" class="form-control">
								</div>
							</div>
							<div class="control-group">
								<label class="control-label " style="color: Black;">Mật
								...
								<div class="controls">
									<input type="password" placeholder="Nhập mật khẩu mới"
										name="passwordmoi" class="form-control">
								</div>
							</div>
							<div class="control-group">
								<label class="control-label " style="color: Black;">Xác
									nhận mật khẩu mới:</label>
								<div class="controls">
									<input type="password" placeholder="Nhập mật khẩu xác nhận"
										name="passwordxacnhan" class="form-control">
								</div>
							</div>
							<p style="color: green;">${thongbaothanhcong}</p>
							<p style="color: red;">${thongbaothatbai}</p>
							<div class="control-group">
